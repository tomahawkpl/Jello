...
public class NextFitHistogramTest extends InstrumentationTestCase {
	...
	public void testSimple() {
		// is initially empty
		assertEquals(NextFitHistogram.NO_PAGE, nextFitHistogram.getWitness((short) 1));
		...
		assertEquals(NextFitHistogram.NO_PAGE, nextFitHistogram.getWitness((short) 100));
		assertEquals(NextFitHistogram.NO_PAGE, nextFitHistogram.getWitness((short) 101));
		assertEquals(NextFitHistogram.NO_PAGE, nextFitHistogram.getWitness((short) 512));
